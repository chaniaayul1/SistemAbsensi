 ...
 * @author chani
 */
public class dashboard_ks extends javax.swing.JFrame {
    Connection con;
    Statement stat;
...
//ANGKATAN
    ...
    private void initComponents() {
        ...
        btn_keluar.add(lb_keluar, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 0, 270, 50));
        ...
        paneldashboard.add(btn_keluar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 690, 330, 50));
...
//ANGKATAN   
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dashboard_ks.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dashboard_ks().setVisible(true);
