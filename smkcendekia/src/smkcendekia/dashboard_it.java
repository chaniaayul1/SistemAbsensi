 ...
 * @author chani
 */
public class dashboard_it extends javax.swing.JFrame {
    Connection con;
    Statement stat;
...
//ANGKATAN   
    ...
    private void btn_kelolaabsensiMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_kelolaabsensiMousePressed
        keloladata_it kit=new keloladata_it();
        kit.setVisible(true);
        this.setVisible(false);
        kit.notifikasialphasemester();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dashboard_it.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dashboard_it().setVisible(true);
