...
public class keloladata_bk extends javax.swing.JFrame {
    ...
    public void walastambahsiswa(){
        try{ System.out.println("ChaniaAyurafiiiiiiiiiiiiii");
    ...
    public void tampilanggotawalikelas(){
        ...
        model.addColumn("Jenis Kelamin");  
         ...
         try{
           stat = con.createStatement( );
           sql  = "Select * from siswa where idwalikelas='"+txt_idprofilewalikelas.getText()+"'";
           rs   = stat.executeQuery(sql);
           int no = 1;
           while(rs.next ()){
                Object[ ] obj = new Object[4];
    ...
    public void chartanggotawalikelas(){
        ...
        try{
           ...
           sql  = "Select * from lapabsen where idwalikelas='"+lb_idanggotawalikelas.getText()+"'";
           rs   = stat.executeQuery(sql);
           /*while(rs.next ()){
               if(rs.getString("jeniskelamin").equals("Laki-Laki")){
                   laki=laki+1;
               }
               else if(rs.getString("jeniskelamin").equals("Perempuan")){
...
//            "Lihat Profile Wali Kelas Gagal", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void initComponents() {
        ...
        panelsiswa.add(btn_riwayatsiswa);
        btn_riwayatsiswa.setBounds(780, 590, 130, 40);
        ...
        btn_lihatsiswa.setBounds(780, 540, 130, 40);
        ...
        btn_hapussiswa.setBounds(920, 590, 130, 40);
        ...
        tabsiswa.setBounds(50, 170, 1010, 360);
        ...
        btn_tambahsiswa.setBounds(920, 540, 130, 40);
        ...
        panelriwayatsiswa.add(lb_tglrs, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 195, 70, 20));
        ...
        panelriwayatsiswa.add(lb_nkriwayatsiswa, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 125, 250, 20));

        lb_namariwayatsiswa.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        panelriwayatsiswa.add(lb_namariwayatsiswa, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 150, 250, 20));
        ...
        if (tabel_riwayatsiswa.getColumnModel().getColumnCount() > 0) {
            tabel_riwayatsiswa.getColumnModel().getColumn(2).setHeaderValue("NK");
        }
        ...
        panelriwayatsiswa.add(btn_searchriwayatsiswa, new org.netbeans.lib.awtextra.AbsoluteConstraints(555, 190, 30, 30));
        ...
        panelguru.add(btn_lihatguru, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 550, 130, 40));
        ...
        panelguru.add(brn_hapusguru, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 594, 130, 40));
        ...
        lb_alamatprofileguru2.setFont(new java.awt.Font("Noto Serif", 0, 18)); // NOI18N
        ...
        panelwalikelas.add(btn_lihatwalikelas, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 595, 130, 40));
        ...
        panelwalikelas.add(brn_hapuswalikelas, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 595, 130, 40));
        ...
        lb_alamatprofilewalikelas1.setFont(new java.awt.Font("Noto Serif", 0, 18)); // NOI18N
        ...
        panelkelas.add(btn_addkelas, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 580, 130, 40));
        panelkelas.add(txt_searchkelas, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 108, 940, 34));
        ...
        panelkelas.add(btn_hapuskelas, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 580, 130, 40));
        ...
        paneladmin.add(btn_registrasi, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 570, 130, 40));
        ...
        jLabel27.setText(":");
        panellapabsensi.add(jLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 110, -1, -1));

        jLabel29.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel29.setForeground(new java.awt.Color(0, 51, 204));
        jLabel29.setText(":");
        panellapabsensi.add(jLabel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 140, -1, -1));
