...
public class keloladata_bk extends javax.swing.JFrame  {
    ...
    public void historysiswa(){
        String a1 = null,a2= null,a3 = null,a4= null,
        a5= null,a6= null,a7= null,a8= null,a9= null,a10 = null,a11 = null,a12=null;
        try{
            stat = con.createStatement( );
            sql  = "Select * from siswa where status='Pasif' and nis='"+txt_searchsiswa.getText()+"'";
            rs   = stat.executeQuery(sql);
            while (rs.next()){
                a1=rs.getString("nis");
                a2=rs.getString("idrfid");
                a3=rs.getString("nk");
                a4=rs.getString("idwalikelas");
                a5=rs.getString("nama");
                a6=rs.getString("alamat");
                a7=rs.getString("jeniskelamin");
                a8=rs.getString("email");
                a9=rs.getString("notlp");
                a10=rs.getString("namaortu");
                a11=rs.getString("noortu");
                a12=rs.getString("status");
            }
        }catch(SQLException ex){
            Logger.getLogger(keloladata_bk.class.getName()).log(Level.SEVERE, null, ex);
        }
        try{
            stat = con.createStatement( );
                String simpan = "insert into historysiswa values ('"+a1
                        +"','"+a2
                        +"','"+a3
                        +"','"+a4
                        +"','"+a5
    ...
    public void tampilprofilesiswa(){
        ...
        if (value=="Aktif"){
            try {
                ...
                while(rs.next ()){
                    ...
                    if(obj[11].equals("Aktif")){
                        txt_statussiswa.setText((String)obj[11]);
                    }
                    else{
                        txt_statussiswa.setText((String)obj[11]);
                    }
            ...
            btn_editprofilesiswa.setEnabled(false);
            btn_simpanprofilesiswa.setEnabled(false);
            try {
                stat = con.createStatement( );
                sql="SELECT * from historysiswa WHERE nis='"+Session.getnissiswa()+"'";
                rs   = stat.executeQuery(sql);
                while(rs.next ()){
                    Object[ ] obj = new Object[12];
                    obj[0] =rs.getString("idrfid");
...
//CHART RIWAYAT ABSENSI SELAMA SEKOLAH
    ...
    public void editprofilesiswa(boolean check){
        if (check==true){
            ...
            txt_statussiswa.setEnabled(false);
        }
        else{
    ...
    public void simpanprofilesiswa(){
        String value=txt_statussiswa.getText();
        try {
            // TODO add your handling code here:
            stat = con.createStatement( );
            con.createStatement().executeUpdate("UPDATE rfid set   idrfid='"+txt_rfidsiswa.getText()+"', "
        ...
        try {
            ...
            con.createStatement().executeUpdate("UPDATE siswa set   nis='"+txt_nissiswa.getText()+"', "                                                                       
                                                                        ...
                                                                        + "status='"+txt_statussiswa.getText()+"'"
                                                                        + "WHERE nis='"+txt_searchsiswa.getText()+"'");
            rs   = stat.executeQuery(sql);
...
System.out.println(e);
    ...
    public void deletedatakelas(){
        ...
        try{
            stat = con.createStatement( );
            sql="SELECT js FROM kelas WHERE nk='"+txt_searchkelas.getText()+"'";
            rs   = stat.executeQuery(sql);
            while (rs.next()){
                checkjs=rs.getString("js");
            }
        }
        catch (SQLException ex) {
            System.out.println(ex);
        ...
        if (checkjs.equals("0")){
            ...
            JOptionPane.showMessageDialog(null, ("Terdapat siswa didalam kelas tersebut"), 
            "Delete Data kelas Gagal", JOptionPane.ERROR_MESSAGE);
        }
    }
...
//            "Lihat Profile Wali Kelas Gagal", JOptionPane.INFORMATION_MESSAGE);
    ...
    public void querydataguruadmin(){
        try {
            Object[ ] obj = new Object[1];
            stat = con.createStatement( );
            sql  = "SELECT * FROM guru WHERE nip='"+txt_nipregadmin.getText()+"' AND status='Aktif'";
            rs   = stat.executeQuery(sql);
            while(rs.next ()){
    ...
    public void tampilhistorylapabsen(){
        ...
        model.addColumn("Terlambat");
         try{
          ...
          sql="SELECT la.*, w.nama FROM historylapabsen AS la INNER JOIN walikelas AS w ON la.idwalikelas = w.idwalikelas AND la.status='Pasif'";
          rs   = stat.executeQuery(sql);
           int no =1;
          while(rs.next ()){
                Object[ ] obj = new Object[11];
    ...
    public void searchlapabsen(){
        ...
        if (value.equals("Nama Walikelas")){
        ...
        else if(value.equals("Riwayat Laporan Absensi")){
            int row = tabel_lapabsen.getRowCount();
            for(int a=0;a<row;a++){
                model.removeRow(0);
            }
            try{
                stat = con.createStatement();
                sql  = "SELECT la.*, w.nama FROM historylapabsen AS la INNER JOIN walikelas AS w ON la.idwalikelas = w.idwalikelas WHERE la.nis='"+txt_searchlapabsen.getText()+"'";
                rs   = stat.executeQuery(sql);
    ...
    private void initComponents() {
        ...
        txt_statussiswa = new javax.swing.JTextField();
        ...
        cb_formatsiswa.setBounds(50, 110, 290, 34);
        ...
        txt_statussiswa.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        txt_statussiswa.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        txt_statussiswa.setEnabled(false);
        panelprofilesiswa.add(txt_statussiswa, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 525, 550, 29));
        ...
        btn_simpantambahsiswa.setFont(new java.awt.Font("Zilla Slab SemiBold", 0, 14)); // NOI18N
        ...
        jLabel92.setForeground(new java.awt.Color(0, 51, 204));
        jLabel92.setText(":");
        ...
        bgriwayatsiswa.setForeground(new java.awt.Color(0, 51, 204));
        ...
        panelguru.add(txt_searchguru, new org.netbeans.lib.awtextra.AbsoluteConstraints(348, 110, 630, 34));
        ...
        panelguru.add(btn_searchguru, new org.netbeans.lib.awtextra.AbsoluteConstraints(985, 110, 34, 34));
        ...
        panelguru.add(tabguru, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 170, 1010, 370));
        ...
        panelguru.add(btn_refreshdataguru, new org.netbeans.lib.awtextra.AbsoluteConstraints(1025, 110, 34, 34));
        ...
        jLabel56.setFont(new java.awt.Font("Noto Serif", 1, 14)); // NOI18N
        ...
        jLabel62.setFont(new java.awt.Font("Noto Serif", 1, 14)); // NOI18N
        ...
        jLabel63.setFont(new java.awt.Font("Noto Serif", 1, 14)); // NOI18N
        ...
        jLabel64.setFont(new java.awt.Font("Noto Serif", 1, 14)); // NOI18N
        ...
        jLabel71.setFont(new java.awt.Font("Noto Serif", 1, 14)); // NOI18N
        ...
        jLabel74.setFont(new java.awt.Font("Noto Serif", 1, 14)); // NOI18N
        ...
        jLabel75.setFont(new java.awt.Font("Noto Serif", 1, 14)); // NOI18N
        ...
        bgtambahguru.setFont(new java.awt.Font("Noto Serif", 1, 14)); // NOI18N
        ...
        panelwalikelas.add(txt_searchwalikelas, new org.netbeans.lib.awtextra.AbsoluteConstraints(348, 110, 630, 34));
        ...
        panelwalikelas.add(btn_searchwalikelas, new org.netbeans.lib.awtextra.AbsoluteConstraints(985, 110, 34, 34));
        ...
        panelwalikelas.add(tabwalikelas, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 170, 1010, 370));
        ...
        panelwalikelas.add(btn_refreshdatawalikelas, new org.netbeans.lib.awtextra.AbsoluteConstraints(1025, 110, 34, 34));
        ...
        panelwalikelas.add(cb_formatwalikelas, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 110, 290, 34));
        ...
        jLabel57.setFont(new java.awt.Font("Noto Serif", 1, 14)); // NOI18N
        ...
        jLabel58.setFont(new java.awt.Font("Noto Serif", 1, 14)); // NOI18N
        ...
        jLabel59.setFont(new java.awt.Font("Noto Serif", 1, 14)); // NOI18N
        ...
        jLabel60.setFont(new java.awt.Font("Noto Serif", 1, 14)); // NOI18N
        ...
        jLabel61.setFont(new java.awt.Font("Noto Serif", 1, 14)); // NOI18N
        ...
        jLabel65.setFont(new java.awt.Font("Noto Serif", 1, 14)); // NOI18N
        ...
        jLabel67.setFont(new java.awt.Font("Noto Serif", 1, 14)); // NOI18N
        ...
        jLabel3.setText(":");
        panelkelas.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(125, 105, -1, 30));
        ...
        panelkelas.add(jLabel93, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 105, -1, 30));
        ...
        paneladmin.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 116, -1, -1));
        ...
        cb_lapabsen.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                cb_lapabsenItemStateChanged(evt);
            }
        });
        ...
        btn_cetaklapabsen.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_cetaklapabsenActionPerformed(evt);
            }
        });
    ...
    private void btn_dashboardMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_dashboardMouseClicked
        // TODO add your handling code here:
        this.setVisible(false);
        dashboard_bk ds = new dashboard_bk();
        ds.setVisible(true);
    ...
    private void cb_lapabsenItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cb_lapabsenItemStateChanged
        String value = cb_lapabsen.getSelectedItem().toString();
        if(value.equals("Riwayat Laporan Absensi")){
            this.tampilhistorylapabsen();
        }
        else{
            
        }
    }//GEN-LAST:event_cb_lapabsenItemStateChanged
    ...
    private javax.swing.JTextField txt_statussiswa;
